# Description:
#   CLC Support Level - returns the support level for a given CLC account alias
#
# Commands:
#   *@jarvis support level <alias>* - Returns the support level for a given account alias (does not analyze sub accounts).
