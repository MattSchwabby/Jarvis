# Description:
#   Get Sub Accounts - a list of sub accounts for a given parent alias
#
# Commands:
#   *@jarvis subs <alias>* - Returns a list of sub accounts for the given alias.
