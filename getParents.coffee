# Description:
#   Get Parent Accounts - a list of parent accounts for a given account alias
#
# Commands:
#   *@jarvis parents <alias>* - Returns a list of parent accounts for the given alias.
