# Description:
#   CLC Contact info -  Returns a list of account administrators containing names, email addresses, phone numbers and titles for a given account alias.
#
# Commands:
#   *@jarvis contact info <alias>* -  Returns a list of account administrators containing names, email addresses, phone numbers and titles for a given account alias.
